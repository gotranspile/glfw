...
var (
	...
	GetVersion = glfw.GetVersion
	GetVersionString = glfw.GetVersionString
	GetVulkanGetInstanceProcAddress = glfw.GetVulkanGetInstanceProcAddress
